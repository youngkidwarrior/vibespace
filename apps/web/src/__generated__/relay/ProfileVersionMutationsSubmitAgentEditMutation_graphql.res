...
module Types = {
  ...
  @live
  type rec response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession_resultVersion_createdBy = {
    displayName: string,
    @live id: string,
  }
  @live
  and response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession_resultVersion = {
    createdAt: string,
    createdBy: option<response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession_resultVersion_createdBy>,
    css: string,
    html: string,
    @live id: string,
    revisionNumber: int,
  ...
  @live
  and response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession_selectionSnapshot = {
    @live id: string,
    label: string,
  }
  @live
  and response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession = {
    createdAt: string,
    error: option<string>,
    @live id: string,
    progressPhase: RelaySchemaAssets_graphql.enum_EditProgressPhase,
    prompt: string,
    resultVersion: option<response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession_resultVersion>,
    resultVersionId: option<string>,
    selectionSnapshot: option<response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession_selectionSnapshot>,
  ...
  @live
  and response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession_resultVersion_createdBy = {
    displayName: string,
    @live id: string,
  }
  @live
  and response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession_resultVersion = {
    createdAt: string,
    createdBy: option<response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession_resultVersion_createdBy>,
    css: string,
    html: string,
    @live id: string,
    revisionNumber: int,
  ...
  @live
  and response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession_selectionSnapshot = {
    @live id: string,
    label: string,
  }
  @live
  and response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession = {
    createdAt: string,
    error: option<string>,
    @live id: string,
    progressPhase: RelaySchemaAssets_graphql.enum_EditProgressPhase,
    prompt: string,
    resultVersion: option<response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession_resultVersion>,
    resultVersionId: option<string>,
    selectionSnapshot: option<response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession_selectionSnapshot>,
    status: RelaySchemaAssets_graphql.enum_ProfileEditSessionStatus,
    summary: string,
    updatedAt: string,
    warnings: array<string>,
  }
  @tag("__typename") and response_submitAgentEdit = 
    | @live ProfileEditSessionMutationFailed(
      {
        failedEditSession: option<response_submitAgentEdit_ProfileEditSessionMutationFailed_failedEditSession>,
        message: string,
    ...
    | @live ProfileEditSessionMutationSucceeded(
      {
        providerConversationId: option<string>,
        resultVersionId: option<string>,
        succeededEditSession: response_submitAgentEdit_ProfileEditSessionMutationSucceeded_succeededEditSession,
        summary: string,
        validationErrors: array<string>,
        warnings: array<string>,
      }
  ...
  @live
  type response = {
    submitAgentEdit: response_submitAgentEdit,
  }
  @live
...
@live
let unwrap_response_submitAgentEdit: Types.response_submitAgentEdit => Types.response_submitAgentEdit = RescriptRelay_Internal.unwrapUnion(_, ["ProfileEditSessionMutationFailed", "ProfileEditSessionMutationSucceeded"])
@live
let wrap_response_submitAgentEdit: Types.response_submitAgentEdit => Types.response_submitAgentEdit = RescriptRelay_Internal.wrapUnion
module Internal = {
  @live
  ...
  let wrapResponseConverter: dict<dict<dict<string>>> = %raw(
    json`{"__root":{"submitAgentEdit":{"u":"response_submitAgentEdit"}}}`
  )
  @live
  let wrapResponseConverterMap = {
    "response_submitAgentEdit": wrap_response_submitAgentEdit,
  }
  @live
  ...
  let responseConverterMap = {
    "response_submitAgentEdit": unwrap_response_submitAgentEdit,
  }
  @live
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ProfileVersionMutationsSubmitAgentEditMutation",
    "selections": (v9/*: any*/),
    "type": "Mutation",
    "abstractKey": null
  },
