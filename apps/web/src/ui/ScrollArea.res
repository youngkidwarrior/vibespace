...
let make = (
  ...
  >
    <BaseUi.ScrollArea.Viewport
      ...
      className="focus-visible:ring-neutral-300/50 size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1"
      ?children
    />
    ...
    >
      <BaseUi.ScrollArea.Thumb
        dataSlot="scroll-area-thumb" className="bg-neutral-300 relative flex-1 rounded-full"
      />
    </BaseUi.ScrollArea.Scrollbar>
